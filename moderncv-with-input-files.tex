...
\cvitem{$\bullet$}{\href{https://github.com/star1327p/moderncv-template}{\textit{This CV template}} is created by Christine P. Chai (\texttt{cpchai21@gmail.com}) from the ModernCV template (Xavier Danaux).
