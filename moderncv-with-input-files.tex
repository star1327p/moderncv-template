...
\cvitem{$\bullet$}{This CV template is created by Christine P. Chai (\texttt{cpchai21@gmail.com}) from the ModernCV template (Xavier Danaux).
...
\begin{itemize}
	...
	\item \textbf{Utilize the \texttt{input} command to add a section directly from another \texttt{.tex} file.\newline{When each section is long, this keeps the main document short and easy to maintain.}}
\end{itemize}}
...
\cventry{$\bullet$}{New Start}{}{January 2022 -- Present}{}{First line of description.
